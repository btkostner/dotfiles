...
"what"). Never restate the code, narrate the diff/PR process ("moved this
here", "kept separate for review"), or catalog values already visible in the
surrounding declarations/config.
